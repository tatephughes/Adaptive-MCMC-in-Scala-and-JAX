...
echo "Scala openBlas"
sbt -Ddev.ludovic.netlib.blas.nativeLib=libopenblas.so "runMain complexity_run_IC"

echo "Scala Java Blas"
sbt -Ddev.ludovic.netlib.blas.nativeLib=libopenblasobutnot "runMain complexity_run_IC"

echo "Scala Native Blas"
sbt -Ddev.ludovic.netlib.blas.nativeLib=libblas.so "runMain complexity_run_IC"
