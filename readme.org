...
jax_times_laptop_32 <- cbind(1:50,read.csv("./data/JAX_32_compute_times_laptop_1_d50.csv", header = FALSE)) %>%
  mutate(proc = "JAX32")
names(jax_times_laptop_32) <- c("d","n", "thinrate", "burnin", "time", "b", "proc")
jax_times_laptop_64 <- cbind(1:50,read.csv("./data/JAX_64_compute_times_laptop_1_d50.csv", header = FALSE)) %>%
  mutate(proc = "JAX64")
names(jax_times_laptop_64) <- c("d","n", "thinrate", "burnin", "time", "b", "proc")
scala_times_laptop_1 <- cbind(1:50,read.csv("./data/scala_compute_times_laptop_1_d50.csv", header = FALSE)) %>%
  mutate(proc = "Scala")
names(scala_times_laptop_1) <- c("d","n", "thinrate", "burnin", "time", "b", "proc")
r_times_laptop_1 <- cbind(1:50,read.csv("./data/R_compute_times_laptop_1_d50.csv", header = FALSE)) %>%
  mutate(proc = "R")
