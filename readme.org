...
#+begin_src R :session example :results graphics file :file Figures/time_graph.png :width 1000
...
#+begin_src R :session example :results graphics file :file Figures/b_plot.png :width 1000
