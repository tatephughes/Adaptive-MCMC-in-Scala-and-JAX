...
#+NAME: fig:
[[file:/home/tate/MyProjects/Adaptive-MCMC-in-Scala-and-JAX/Figures/plot_mixing_full.png]]

#+CAPTION: Sub-Optimality Factor across the last 500,000 iterations
#+NAME: fig:
[[file:/home/tate/MyProjects/Adaptive-MCMC-in-Scala-and-JAX/Figures/plot_mixing_zoomed.png]]
...
data <- rbind(jax_times_laptop_32_IC, jax_times_laptop_32_MD,
              ...
              scala_times_laptop_IC_ #, scala_times_laptop_MD)
...
I have yet to properly re-run this.
